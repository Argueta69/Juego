 ...
 * @author argue
 */
public class ShootZombie extends MovingObjetcs{
    
    //Constructor del Knife
    public ShootZombie(Vector2D position, Vector2D velocity, double maxVel, double angle, BufferedImage texture, GameState gameState) {
